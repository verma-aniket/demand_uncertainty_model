...
def main():
    ...
    for fips_code in fips_array:
        ...
        proj_file = REPO_ROOT / "Results" / "Projections" / "BG" / f"proj_monthly_{fips_code}.npy"
        ...
        # save to csv
        output_file = REPO_ROOT / "Results" / "Variance_Decomposition" / f"BG_monthly_{fips_code}.csv"
